...
import { Box, Button, Card, CardActionArea, CardActions, CardContent, CardMedia, CircularProgress, Grid, IconButton, Pagination, Typography } from '@mui/material';
...
const NewsItem = ({ category, searchQuery }) => {
    ...
    useEffect(() => {
        ...
        let url = `http://newsapi.org/v2/top-headlines?country=in&category=${category}&pageSize=100&apiKey=e9a947a395174904ae5d9e8662d757ae`;
